...
class AdminAllActionService {
  Future<Either<StatuseRequest, Map>> getstats(String token,Map<String,String> data) async {
    //Either for return two data type in the same time
    try {
      if (await checkInternet()) {
        Uri url = Uri.parse(ServerConstApis.getActions);
