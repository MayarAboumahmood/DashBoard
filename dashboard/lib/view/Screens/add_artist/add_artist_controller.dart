...
import 'package:dashboard/view/Screens/select_artist/select_artist.dart';
...
class AddArtistController extends GetxController implements StatuseRequestController{
 late String name;
 ...
 formstate = GlobalKey<FormState>();
  ...
  onPressDone() async {
    ...
    if (formdata!.validate()) {
      ...
      dynamic response = await addData(); // check if the return data is statuseRequest or real data
  ...
  whenAddSuccess(response) async {
    ...
    artistController.finalListData=[];
      artistController.finalListData = await artistController.sendingARequestAndHandlingData();
 Get.back();
    update();
